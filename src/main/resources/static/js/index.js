document.addEventListener("DOMContentLoaded", function(){
	...
	var eyes = document.querySelectorAll('.eyes circle');
	var eyel = document.querySelectorAll('.eyes-l');
	var eyer = document.querySelectorAll('.eyes-r');
	var ears = document.querySelectorAll('.ears');
	var earsl = document.querySelector('.ears-l');
	var earsr = document.querySelector('.ears-r');
	var tail = document.querySelector('.tail'); 
	var backlegs = document.querySelector('.backlegs');
	var frontlegs = document.querySelector('.frontlegs');
	var frontlegs1 = document.querySelector('.frontlegs1');
	var backcircle = document.querySelector('.body-backcircle');
	var frontcircle = document.querySelector('.body-frontcircle');
	var bodybetween = document.querySelector('.body-between');
	var logo = document.querySelector('.logoani');
	var logofix = document.querySelector('.logo');
	var resetbutton = document.querySelector('.restart');
	var ani = document.querySelector('.animation-wrapper');
	var layout = document.querySelector('.layout');

	//start-animation
	function initAni(){
		var tl = new TimelineMax({delay:0.5, onComplete:logoVisible});
